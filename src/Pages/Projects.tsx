    ...
    <div className=" dark:bg-gray-800" id="section-projects">
      ...
      <div className="grid place-items-center mt-10">
        <a
          ...
          className="bg-gray-600 shadow-md hover:shadow-xl dark:bg-gray-100 w-fit z-[1] rounded-[7px] px-4 py-2 cursor-pointer flex items-center gap-3 text-white dark:text-gray-800 font-Poppins transition duration-700 ease-in-out hover:-translate-y-1"
        >
          See More
          <IoApps />
        </a>
